...
describe('[REST] Options', () => {
	...
	it('snapshots - option chain /v3/snapshot/options/{underlyingAsset}', async () => {
		...
		requestStub.callCount.should.eql(1);
		requestStub.getCalls()[0].args[0].should.eql('/v3/snapshot/options/AAPL');
	});
	...
	it('sma call /v1/indicators/sma/{optionTicker}', async () => {
		...
		requestStub
			.getCalls()[0]
			.args[0].should.eql('/v1/indicators/sma/O:AAPL230616C00150000');
	});
	...
	it('ema call /v1/indicators/ema/{optionTicker}', async () => {
		...
		requestStub
			.getCalls()[0]
			.args[0].should.eql('/v1/indicators/ema/O:AAPL230616C00150000');
	});
	...
	it('macd call /v1/indicators/macd/{optionTicker}', async () => {
		...
		requestStub
			.getCalls()[0]
			.args[0].should.eql('/v1/indicators/macd/O:AAPL230616C00150000');
	});
	...
	it('rsi call /v1/indicators/rsi/{optionTicker}', async () => {
		...
		requestStub
			.getCalls()[0]
			.args[0].should.eql('/v1/indicators/rsi/O:AAPL230616C00150000');
	});
});
