...
): Promise<ISnapshotTickers> => get(`/v2/snapshot/locale/us/markets/stocks/tickers`, apiKey, apiBase, query);
...
): Promise<ISnapshotTickers> => get(`/v2/snapshot/locale/us/markets/stocks/${direction}`, apiKey, apiBase);
...
export const snapshotTicker = async (
	...
	apiBase: string,
	symbol: string 
): Promise<ISnapshot> => get(`/v2/snapshot/locale/us/markets/stocks/tickers/${symbol}`, apiKey, apiBase);
