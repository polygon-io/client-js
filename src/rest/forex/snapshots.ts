...
): Promise<IForexSnapshotTickers> => get(`/v2/snapshot/locale/global/markets/forex/tickers`, apiKey, apiBase, query);
...
): Promise<IForexSnapshotTickers> => get(`/v2/snapshot/locale/global/markets/forex/${direction}`, apiKey, apiBase);
...
export const snapshotTicker = async (
	...
	apiBase: string,
	symbol: string 
): Promise<IForexSnapshot> => get(`/v2/snapshot/locale/global/markets/forex/tickers/${symbol}`, apiKey, apiBase);
