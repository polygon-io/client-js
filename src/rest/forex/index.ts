...
import { IHistoricTicksQuery, IHistoricTicks, historicTicks } from './historicTicks';
import { IForexLastQuote, lastQuote } from './lastQuote';
import { previousClose } from './previousClose';
import { IForexSnapshotAllTickersQuery,  IForexSnapshotTickers, IForexSnapshot, snapshotAllTickers, snapshotGainersLosers, snapshotTicker} from './snapshots';
