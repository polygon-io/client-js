...
import { ICryptoDailyOpenCloseQuery, ICryptoDailyOpenClose, dailyOpenClose } from './dailyOpenClose';
import { IHistoricTradeQuery, IHistoricTrade, historicTrades } from './historicTrades';
import { ICryptoLastTrade, lastTrade } from './lastTrade';
import { previousClose } from './previousClose';
import { ICryptoSnapshotAllTickersQuery,  ICryptoSnapshotTickers, ICryptoSnapshot, ICryptoSnapshotFullBookL2, snapshotAllTickers, snapshotGainersLosers, snapshotTicker, snapshotTickerFullBookL2} from './snapshots';
